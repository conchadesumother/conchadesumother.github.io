...
{% comment %}
  This line filters posts to only show those with the 'portafolio' tag.
  The rest of the code is the same as your homepage layout.
{% endcomment %}
{% assign posts = site.posts | where_exp:"post","post.tags contains 'portafolio'" %}

<main class="home no-padding" role="main">
    {% comment %}
      We remove the Hero section and pagination from this page.
      You can uncomment them if you need them.
    {% endcomment %}
